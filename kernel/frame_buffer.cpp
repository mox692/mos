...
// MEMO: bookではshadow_bufferと呼ばれているもの(ref: p234)
// FrameBufferConfigの内容に応じて、(screen全体を司る)writerを生成する.
Error FrameBuffer::Initialize(const FrameBufferConfig& config) {
  ...
  // MEMO: ref239
  // shadow_bufferではなく、実際のframe bufferが渡ってきた時
  // 設定を書き込む.
  ...
  switch (config_.pixel_format) {
    case kPixelRGBResv8BitPerColor:
      // make_unique ref: https://qiita.com/seriru13/items/06d044cbe5bcc44cca10
...
// MEMO: shadow_bufferの内容を実際のframe bufferにcopyする.
